...
BEGIN
 ...
 -- Start generating exam questions
  ...
  BEGIN
    ...
    -- Insert a new row into the Questions_Consist_Exam table to connect the [selected question] with [the exam]
...
--Unique key and not null constraint.