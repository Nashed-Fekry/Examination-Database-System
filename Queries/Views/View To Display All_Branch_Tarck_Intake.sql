create or alter view All_Branch_Tarck_Intake
as
   select  B.Branch_Name,t.Track_Name,intk.Intake_Name  from Students S inner join Student_Branch SB
...
select * from All_Branch_Tarck_Intake